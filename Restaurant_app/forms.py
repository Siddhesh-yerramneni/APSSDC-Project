...
from Restaurant_app.models import Breads, Chinese, Curries, Rice, Starters, Rolereq, Thickshake, User
...
class Riceform(forms.ModelForm):
    class Meta:
        model=Rice
        fields = ["rbname","rbcategory","rbprice","rbimage"]
        widgets = {
...
class Curriesform(forms.ModelForm):
    class Meta:
        model=Curries
        fields = ["cname","ccategory","cprice","cimage"]
        widgets = {
...
class Thickshakeform(forms.ModelForm):
    class Meta:
        model=Thickshake
        fields = ["tname","tprice","timage"]
        widgets = {
            "tname":forms.TextInput(attrs={
                "class":"form-control my-2",
                "placeholder":"Enter name",
            }),
            "tprice":forms.NumberInput(attrs={
                "class":"form-control my-2",
                "placeholder":"Enter Price",
            })
        }
...
class Chineseform(forms.ModelForm):
    class Meta:
        model=Chinese
        fields = ["chname","chcategory","chprice","chimage"]
        widgets = {
            "chname":forms.TextInput(attrs={
                "class":"form-control my-2",
                "placeholder":"Enter name",
            }),
            "chcategory":forms.Select(attrs={
               "class":"form-control my-2",
            }),
            "chprice":forms.NumberInput(attrs={
                "class":"form-control my-2",
                "placeholder":"Enter Price",
            })
        }
